...
#pragma warning disable HLQ006 // GetEnumerator() or GetAsyncEnumerator() should return a value type
        public AsyncRecordEnumeratorCore<char, CharLineFormat, TModel, ReflectionLineParser<TModel>, TextReaderSource> GetAsyncEnumerator(CancellationToken cancellationToken = default)
#pragma warning restore HLQ006 // GetEnumerator() or GetAsyncEnumerator() should return a value type
        {
            return new(new ReflectionLineParser<TModel>(_parser), _source.Create(_bufferSize), _formatProvider, _stringPool, _bufferSize, cancellationToken);
        }
